...
func = (arg1, arg2) => {}
// func = arg1, arg2 => {} // 1. func = arg1; / arg => {};
...
// single line block
func = (arg) => {return arg * arg;}

// 구현부가 한줄이면 중괄호를 생략할 수 있으며, 해당 구문의 결과를 return
func = (arg) => arg * arg; // 중괄호를 생략하려면 return도 생략

// 구현부가 한줄이면서 객체 리터럴을 반환할 때 함수의 중괄호를 제거하면 객체 리터럴을 소괄호로 묶어야 함
func = (name, tombName) => {
    return {
        name,
        tombName
