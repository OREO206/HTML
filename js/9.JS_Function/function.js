/*
    ...
    - 동일한 코드를 반복해서 작성할 필요 없이 미리 하나의 코드만 작성한 후 호출하여 사용해서 코드의 재사용성을 높일 수 있음
    - 특정 기능이나 코드 구문에 대해서 이름을 부여하는 용도로 사용할 수 있음
    - 특정 작업들에 대해서 모듈화를 위한 용도로 사용할 수 있다
*/
function add (x, y) {
    return x + y;
}
...
/*
    함수 표현식 : 함수도 객체 리터럴 방식으로 정의 할 수 있고 변수에 할당할 수 있음 
*/
/*
    - 기명 함수 표현식
*/
...
function add2 (prePrecessing, x, y) {
    return prePrecessing(x) + prePrecessing(y);
}
