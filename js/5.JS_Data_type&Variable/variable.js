...
*/
var varVariable; // 문제가 있는 변수선언이라 let을 씀
let letVariable;
const constVariable = 10; // const는 상수. 스크립트에서 상수를 쓰면 반드시 초기화를 해야 함
...
variable = '10';
// console.log(typeof variable); // typeof = 변수 안에 있는 데이터 타입을 찍어줌
...
// console.log(x); // 선언되지않은 값이 일단 할당 돼서 undefined가 찍힘
var x = 10;
if(true) {
    var x = 99;
}
