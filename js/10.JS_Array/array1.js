...
/*
    배열의 순회
    - for-in 문을 사용하여 index 값을 가지고 순회가 가능
*/
const fruits = ['apple', 'banana', 'melon'];
for (let index = 0; index < fruits.length; index++) {
    console.log(fruits[index]); // app banana melon
}
...
/*
    - for-in 순회 방식은 index를 사용하여 한번 더 작업해야 하기 때문에 요소를 읽어 들이는 순회에는 적합하지 않을 수 있음
    - forEach 메서드 혹은 for - of 문을 사용
*/

// of 쓰면 item 값을 읽기 전용으로 가져와서 수정할 수 없음 그래서 in 써서 수정할 수 있음
