...
// 선대입 후증가 - 먼저 대입하고 그 다음 증가
result = single++ * 8; // 0
// 선증가 후대입
result = ++single * 8; // 16 - 위에서 증가 된 상태 1에서 한번 더 증가 돼어 2 * 8 됨
// 선대입 후감소
...
*/
const number = 9;
// const result2 = number % 2 === 0 ? '짝수':'홀수'; // number % 2가 1이면 홀수 0이면 짝수냐는 뜻 // 홀수
let result2 = number % 2 ? '홀수':'짝수'; // 위랑 같은 것
console.log(result2);
